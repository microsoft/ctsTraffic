...
namespace ctsTraffic
{
    ...
    public:
        ...
        void PrintStatistics(const wil::networking::socket_address&,
                             const wil::networking::socket_address&) noexcept override
        {
        ...
        void PrintTcpInfo(const wil::networking::socket_address&, const wil::networking::socket_address&,
