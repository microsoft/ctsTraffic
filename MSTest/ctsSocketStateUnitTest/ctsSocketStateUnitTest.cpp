    ...
    {
        {
            ...
            case ctsTraffic::ctsSocketState::InternalState::Creating:
                return L"Creating";
            case ctsTraffic::ctsSocketState::InternalState::InitiatedIo:
                return L"InitiatedIo";
            case ctsTraffic::ctsSocketState::InternalState::Closed:
                return L"Closed";
            case ctsTraffic::ctsSocketState::InternalState::Closing:
                return L"Closing";
            case ctsTraffic::ctsSocketState::InternalState::Connected:
                return L"Connected";
            case ctsTraffic::ctsSocketState::InternalState::Connecting:
                return L"Connecting";
            case ctsTraffic::ctsSocketState::InternalState::Created:
                return L"Created";
            default:
                return {};
            }
...
static void CreateFunctionHook(const std::weak_ptr<ctsSocket>& socket) noexcept
{
...
static void ConnectFunctionHook(const std::weak_ptr<ctsSocket>& socket) noexcept
{
    const auto sharedSocket(socket.lock());
    Assert::IsNotNull(sharedSocket.get());
...
static void IoFunctionHook(const std::weak_ptr<ctsSocket>& socket) noexcept
{
    const auto sharedSocket(socket.lock());
    Assert::IsNotNull(sharedSocket.get());
