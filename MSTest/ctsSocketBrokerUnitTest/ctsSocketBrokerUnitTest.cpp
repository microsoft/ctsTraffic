...
public:
    ...
    void print_objects() noexcept
    {
        ...
        Logger::WriteMessage(
            wil::str_printf<std::wstring>(L"\tSocketStatePool Creating objects : %ld\n", creatingObjects).c_str());
        ...
        Logger::WriteMessage(
            wil::str_printf<std::wstring>(L"\tSocketStatePool InitiatingIo objects : %ld\n", initiatingIoObjects).
            c_str());
        ...
        Logger::WriteMessage(
            wil::str_printf<std::wstring>(L"\tSocketStatePool Closed objects : %ld\n", closedObjects).c_str());
        ...
        Logger::WriteMessage(
            wil::str_printf<std::wstring>(L"\tSocketStatePool null objects : %ld\n", nullObjects).c_str());
    }
