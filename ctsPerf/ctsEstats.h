...
namespace ctsPerf { namespace Details
    ...
    template <TCP_ESTATS_TYPE TcpType>
    void SetPerConnectionEstats(
        MIB_TCPROW * const tcpRow,
    ...
    inline ULONG GetPerConnectionStaticEstats(MIB_TCPROW * const tcpRow, TCP_ESTATS_SYN_OPTS_ROS_v0 * pRos)
    noexcept
        {
    ...
    template <TCP_ESTATS_TYPE TcpType>
    ULONG GetPerConnectionStaticEstats(
        MIB_TCPROW * const tcpRow,
        typename EstatsTypeConverter<TcpType>::read_only_static_type * pRos)
    noexcept
        {
    ...
    // TcpConnectionEstatsSynOpts is unique in that there isn't a RW type to query for
    inline ULONG GetPerConnectionStaticEstats(MIB_TCP6ROW * const tcpRow, TCP_ESTATS_SYN_OPTS_ROS_v0 * pRos)
    noexcept
        {
    ...
    template <TCP_ESTATS_TYPE TcpType>
    ULONG GetPerConnectionDynamicEstats(
        MIB_TCPROW * const tcpRow,
