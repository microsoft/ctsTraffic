...
namespace ctl
{
    ...
    //
    ////////////////////////////////////////////////////////////////////////////////
    inline bool ctWmiEnumerate::iterator::operator==(_In_ const iterator& _iter) const NOEXCEPT
    {
    ...
    // postincrement
    inline ctWmiEnumerate::iterator  ctWmiEnumerate::iterator::operator++(_In_ int)
    {
        iterator temp(*this);
        this->increment();
        return temp;
    ...
    inline ctWmiEnumerate::iterator& ctWmiEnumerate::iterator::operator+=(_In_ DWORD _inc)
    {
