...
namespace ctl {
    ...
    public:
        ...
        ctWmiErrorInfo(_In_ const ctWmiErrorInfo& _inObj) NOEXCEPT : error_info(_inObj.error_info)
        {
        }
        // assignment operators with lvalues and rvalues
        ctWmiErrorInfo& operator=(_In_ const ctWmiErrorInfo& _inObj) NOEXCEPT
        {
        ...
        // move c'tors
        ctWmiErrorInfo(_In_ ctWmiErrorInfo&& _inObj) NOEXCEPT : error_info(nullptr)
        {
            this->swap(_inObj);
        }
        ctWmiErrorInfo& operator=(_In_ ctWmiErrorInfo&& _inObj) NOEXCEPT
        {
