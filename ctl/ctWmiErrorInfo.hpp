...
public:
    // c'tors and d'tor
    ctWmiErrorInfo() throw() : error_info(NULL)
    {
        get_error_info();
    }
    ctWmiErrorInfo(_In_ const ctComPtr<IWbemClassObject>& _error_info) throw() : error_info(_error_info)
    {
    }
    ~ctWmiErrorInfo() throw() 
    {
    }

    // copy c'tor and move c'tor
    ctWmiErrorInfo(_In_ const ctWmiErrorInfo& _inObj) throw() : error_info(_inObj.error_info)
    {
    }
    // assignment operators with lvalues and rvalues
    ctWmiErrorInfo& operator=(_In_ const ctWmiErrorInfo& _inObj) throw() 
    {
        ctWmiErrorInfo temp(_inObj);
        this->swap(temp);
        return *this;
    }
    ...
    **************************************************************************************************/
    #ifndef _STL70_
    // move c'tors
    ctWmiErrorInfo(_In_ ctWmiErrorInfo&& _inObj) throw() : error_info(NULL)
    {
        this->swap(_inObj);
    }
    ctWmiErrorInfo& operator=(_In_ ctWmiErrorInfo&& _inObj) throw() 
    {
        ctWmiErrorInfo temp(std::move(_inObj));
        this->swap(temp);
        return *this;
    }
    #endif

    void get_error_info() throw()
    {
    ...
    bool has_error() const throw()
    {
        return (this->error_info.get() != NULL);
    }
    ...
    void swap(_Inout_ ctWmiErrorInfo& _lhs) throw()
    {
        using std::swap;
    ...
    //
    _Success_(return)
    bool get_ProviderName(_Inout_ std::wstring* _provider_name) const
    {
    ...
    _Success_(return)
    bool get_Operation(_Inout_ std::wstring* _operation) const
    {
        _operation->clear();
    ...
    _Success_(return)
    bool get_ParameterInfo(_Inout_ std::wstring* _parameter_info) const
    {
    ...
    _Success_(return)
    bool get_Description(_Inout_ std::wstring* _description) const
    {
        _description->clear();
    ...
    _Success_(return)
    bool get_StatusCode(_Out_ unsigned int* _status_code) const
    {
    ...
    //
    _Success_(return)
    bool get_ErrorType(_Out_ unsigned* _error_type) const
    {
    ...
    _Success_(return)
    bool get_OtherErrorType(_Inout_ std::wstring* _other_error_type) const
    {
    ...
    _Success_(return)
    bool get_OwningEntity(_Inout_ std::wstring* _owning_entity) const
    {
    ...
    _Success_(return)
    bool get_MessageID(_Inout_ std::wstring* _message_id) const
    {
        _message_id->clear();
    ...
    _Success_(return)
    bool get_Message(_Inout_ std::wstring* _message) const
    {
        _message->clear();
    ...
    _Success_(return)
    bool get_MessageArguments(_Inout_ std::vector<std::wstring>* _message_arguments) const
    {
    ...
    _Success_(return)
    bool get_PerceivedSeverity(_Out_ unsigned short* _perceived_severity) const
    {
    ...
    _Success_(return)
    bool get_ProbableCause(_Out_ unsigned short* _probable_cause) const
    {
    ...
    _Success_(return)
    bool get_ProbableCauseDescription(_Inout_ std::wstring* _probable_cause_description) const
    {
    ...
    _Success_(return)
    bool get_RecommendedActions(_Inout_ std::vector<std::wstring>* _recommended_actions) const
    {
    ...
    _Success_(return)
    bool get_ErrorSource(_Inout_ std::wstring* _error_source) const
    {
        _error_source->clear();
    ...
    _Success_(return)
    bool get_ErrorSourceFormat(_Out_ unsigned short* _error_source_format) const
    {
    ...
    _Success_(return)
    bool get_OtherErrorSourceFormat(_Inout_ std::wstring* _other_error_source_format) const
    {
    ...
    _Success_(return)
    bool get_CIMStatusCode(_Out_ unsigned int* _cim_status_code) const
    {
        *_cim_status_code = 0;
    ...
    _Success_(return)
    bool get_CIMStatusCodeDescription(_Inout_ std::wstring* _cim_status_code_description) const
    {
...
private:
    ...
    template <typename T>
    _Success_(return)
    bool get_parameter_value(_In_ LPCWSTR _parameter, _Out_ T* _value) const
    {
        ctComVariant var;
        if (this->error_info.get() != NULL) {
            HRESULT hr = this->error_info->Get(_parameter, 0, var.get(), 0, 0);
            if (FAILED(hr)) {
...
//
inline
void swap(_Inout_ ctWmiErrorInfo& _rhs, _Inout_ ctWmiErrorInfo& _lhs) throw()
{
    _rhs.swap(_lhs);
}
