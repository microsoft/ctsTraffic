...
////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        //
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        inline std::string convert_to_string(const std::wstring& _wstr)
        {
            if (_wstr.length() == 0) {
                return std::string();
            }
        ...
        inline std::wstring convert_to_wstring(const std::string& _str)
        {
            if (_str.length() == 0) {
                return std::wstring();
            }
        ...
        namespace _detail
        {
                ...
                BOOL _case_insensitive)
            {
                switch (::CompareStringOrdinal(
                    ...
                    default:
                        throw ctl::ctException(::GetLastError(), L"CompareStringOrdinal", L"ctl::ctString::impl_ordinal_equals", false);
                }
            }
...
#pragma region Desktop Family
                ...
                BOOL _case_insensitive)
            {
                switch (::CompareStringA(
                    ...
                    default:
                        throw ctl::ctException(::GetLastError(), L"CompareString", L"ctl::ctString::impl_ordinal_equals", false);
                }
            }
#else
            inline bool impl_ordinal_equals(
...
#pragma endregion
            ...
            inline _Ret_z_ const wchar_t* convert_to_ptr(const std::wstring& source)
            {
                return source.c_str();
            }
            inline size_t get_string_length(const std::wstring& source)
            {
                return source.length();
            }

            inline _Ret_z_ const wchar_t* convert_to_ptr(_In_z_ const wchar_t* source)
            {
                return source;
            }
            inline size_t get_string_length(_In_z_ const wchar_t* source)
            {
                return ::wcslen(source);
            }

            inline _Ret_z_ const char* convert_to_ptr(const std::string& source)
            {
                return source.c_str();
            }
            inline size_t get_string_length(const std::string& source)
            {
                return source.length();
            }

            inline _Ret_z_ const char* convert_to_ptr(_In_z_ const char* source)
            {
                return source;
            }
            inline size_t get_string_length(_In_z_ const char* source)
            {
...
#pragma prefast(suppress:26018, "OACR doesn't offer a way to annotate the requirement that wcslen(convert_to_ptr(x)) == get_string_length(x)")
            return ::ctl::ctString::_detail::impl_ordinal_equals(
                ::ctl::ctString::_detail::convert_to_ptr(_lhs),
                ::ctl::ctString::_detail::get_string_length(_lhs),
                ::ctl::ctString::_detail::convert_to_ptr(_rhs),
                ::ctl::ctString::_detail::get_string_length(_rhs),
                FALSE);
        }
        template <typename LeftStringT, typename RightStringT>
...
#pragma prefast(suppress:26018, "OACR doesn't offer a way to annotate the requirement that wcslen(convert_to_ptr(x)) == get_string_length(x)")
        ...
        //
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        inline void replace_all(std::wstring& _original_string, const std::wstring& _search_string, const std::wstring& _replacement_string)
        {
            size_t search_size = _search_string.size();
            size_t replacement_size = _replacement_string.size();
            size_t index = 0;
        ...
        inline std::wstring replace_all_copy(std::wstring _original_string, const std::wstring& _search_string, const std::wstring& _replacement_string)
        {
            replace_all(_original_string, _search_string, _replacement_string);
            return _original_string;
        }

        inline void replace_all(std::string& _original_string, const std::string& _search_string, const std::string& _replacement_string)
        {
            size_t search_size = _search_string.size();
            size_t replacement_size = _replacement_string.size();
            size_t index = 0;
        ...
        inline std::string replace_all_copy(std::string _original_string, const std::string& _search_string, const std::string& _replacement_string)
        {
            replace_all(_original_string, _search_string, _replacement_string);
            return _original_string;
        }
        ...
        //
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        inline void escape_wmi_query(std::wstring& _unescaped_string)
        {
        ...
        inline std::wstring escape_wmi_query_copy(std::wstring _unescaped_string)
        {
        ...
        //
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        inline std::wstring __cdecl format_string_va(_Printf_format_string_ LPCWSTR _format_string, va_list _args)
        {
            std::wstring formatted_string(_format_string);
            // loop until the formatted string will fit
            for (;;)
            {
                int new_size = ::_vsnwprintf_s(
                    &formatted_string[0],
                ...
                if (new_size != -1) {
                    ...
                    size_t size_to_grow = static_cast<size_t>(formatted_string.size() * 1.5);
        ...
        inline std::wstring __cdecl format_string(_Printf_format_string_ LPCWSTR _format_string, ...)
        {
            va_list args;
        ...
        //
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        inline std::wstring format_exception(const ctException& _exception)
        {
            bool what_exists = ::wcslen(_exception.what_w()) > 0;
            bool where_exists = ::wcslen(_exception.where_w()) > 0;
...
#ifdef _CPPRTTI
        inline std::wstring format_exception(const std::exception& _exception)
        {
