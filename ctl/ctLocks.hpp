...
namespace ctl
{
	...
	public:
		...
		explicit ctAutoReleaseCriticalSection(_In_ CRITICAL_SECTION* _cs) noexcept : cs(_cs)
		{
		...
		ctAutoReleaseCriticalSection(ctAutoReleaseCriticalSection&&) = delete;
		ctAutoReleaseCriticalSection operator=(ctAutoReleaseCriticalSection&&) = delete;
	...
	public:
		...
		ctPrioritizedCriticalSection(ctPrioritizedCriticalSection&&) = delete;
		ctPrioritizedCriticalSection& operator=(ctPrioritizedCriticalSection&&) = delete;
	...
	public:
		...
		ctAutoReleasePriorityCriticalSection(ctAutoReleasePriorityCriticalSection&&) = delete;
		ctAutoReleasePriorityCriticalSection operator=(ctAutoReleasePriorityCriticalSection&&) = delete;
	...
	public:
		...
		ctAutoReleaseDefaultCriticalSection(ctAutoReleaseDefaultCriticalSection&&) = delete;
		ctAutoReleaseDefaultCriticalSection operator=(ctAutoReleaseDefaultCriticalSection&&) = delete;
