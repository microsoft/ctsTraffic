...
public:
    ...
    ctWmiService(const ctWmiService& _service) : coinit(), wbemLocator(_service.wbemLocator), wbemServices(_service.wbemServices)
    {
        // empty
    }
    ctWmiService& operator=(const ctWmiService& _service)
    {
    ...
    ////////////////////////////////////////////////////////////////////////////////
    IWbemServices* operator->() throw()
    {
        return this->wbemServices.get();
    }
    const IWbemServices* operator ->() const throw()
    {
        return this->wbemServices.get();
    }

    bool operator ==(const ctWmiService& _service) const throw()
    {
    ...
    IWbemServices* get() throw()
    {
        return this->wbemServices.get();
    }
    const IWbemServices* get() const throw()
    {
        return this->wbemServices.get();
    }
