...
namespace ctl
{
    ...
    namespace ctTimer
    {
        ...
        //
        inline long long convert_msec_hundredNs(long long _milliseconds) NOEXCEPT
        {
        ...
        // (FILETIME records time in one-hundred-nano-seconds)
        //
        inline long long convert_hundredNs_msec(long long _hundred_nanoseconds) NOEXCEPT
        {
        ...
        // (FILETIME records time in one-hundred-nano-seconds)
        //
        inline FILETIME convert_hundredNs_absolute_filetime(long long _hundred_nanoseconds) NOEXCEPT
        {
        ...
        //
        inline FILETIME convert_hundredNs_relative_filetime(long long _hundred_nanoseconds) NOEXCEPT
        {
            ULARGE_INTEGER ulong_integer;
        ...
        // (FILETIME records time in one-hundred-nano-seconds)
        //
        inline long long convert_filetime_hundredNs(const FILETIME& _filetime) NOEXCEPT
        {
            ULARGE_INTEGER ulong_integer;
        ...
        // (FILETIME records time in one-hundred-nano-seconds)
        //
        inline FILETIME convert_msec_absolute_filetime(long long _milliseconds) NOEXCEPT
        {
            return convert_hundredNs_absolute_filetime(convert_msec_hundredNs(_milliseconds));
        }
        inline FILETIME convert_msec_relative_filetime(long long _milliseconds) NOEXCEPT
        {
        ...
        // (FILETIME records time in one-hundred-nano-seconds)
        //
        inline long long convert_filetime_msec(const FILETIME& _filetime) NOEXCEPT
        {
            ULARGE_INTEGER ulong_integer;
            ulong_integer.HighPart = _filetime.dwHighDateTime;
            ulong_integer.LowPart = _filetime.dwLowDateTime;
        ...
        inline long long snap_qpf() NOEXCEPT
        {
        ...
        inline long long snap_qpc_as_msec() NOEXCEPT;
#else
        inline long long snap_qpc_as_msec() NOEXCEPT
        {
            (void) ::InitOnceExecuteOnce(&s_QpfInitOnce, s_QpfInitOnceCallback, nullptr, nullptr);
        ...
        // (FILETIME records time in one-hundred-nano-seconds)
        //
        inline FILETIME snap_qpc_as_filetime() NOEXCEPT
        {
        ...
        // (FILETIME records time in one-hundred-nano-seconds)
        //
        inline FILETIME snap_system_time_as_filetime() NOEXCEPT
        {
            FILETIME return_filetime;
        ...
        //
        inline long long snap_system_time_as_msec() NOEXCEPT
        {
