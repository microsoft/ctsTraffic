...
namespace ctsTraffic
{
	...
	//
	static ctsSendRecvStatus ctsSendRecvProcessTask(SOCKET socket, const std::shared_ptr<ctsSocket>& sharedSocket, ctsIoPattern* const sharedPattern, const ctsTask& nextIo) noexcept
	{
		...
		else if (ctsTaskAction::GracefulShutdown == nextIo.m_ioAction)
		{
