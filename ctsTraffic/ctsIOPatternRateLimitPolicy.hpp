...
namespace ctsTraffic
{
    ...
    using ctsIOPatternRateLimitDoNotThrottle = struct ctsIOPatternRateLimitDontThrottle_t;
    ...
    ///
    template <>
    struct ctsIOPatternRateLimitPolicy<ctsIOPatternRateLimitDoNotThrottle>
    {
    ...
    private:
        ...
        {
            return m_quantumStartTimeMs + static_cast<int64_t>(m_bytesSentThisQuantum / m_bytesSendingPerQuantum *
                m_quantumPeriodMs);
        }
    };
}
