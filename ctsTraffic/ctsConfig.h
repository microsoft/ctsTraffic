...
namespace ctsTraffic
{
	...
	using wil::network::socket_address_wstring;
	//
	...
	namespace ctsConfig
	{
		extern wil::network::winsock_extension_function_table g_socketFunctions;
		extern wil::network::rio_extension_function_table g_rioFunctions;
