...
If you would like to download the latest build and not have to pull down the source code to build it yourself, you can download them from [https://github.com/microsoft/ctsTraffic/tree/master/Releases/2.0.3.5](https://github.com/microsoft/ctsTraffic/tree/master/Releases/2.0.3.5) .
